...
func on_home_hub_pressed(hub_name: String, mode_interval: int, mode_chord: int, mode_progression: int, mode_scale_mode: int, mode_cadence: int, mode_sight: int, mode_note_chase: int, mode_read: int) -> void:
	...
	if hub_name == "Practice":
		if selected_mode != mode_interval and selected_mode != mode_chord and selected_mode != mode_progression and selected_mode != mode_scale_mode and selected_mode != mode_cadence and selected_mode != mode_sight and selected_mode != mode_note_chase:
...
func on_ear_mode_pressed(mode: int, mode_interval: int, mode_chord: int, mode_progression: int, mode_scale_mode: int, mode_cadence: int) -> void:
	if mode != mode_interval and mode != mode_chord and mode != mode_progression and mode != mode_scale_mode and mode != mode_cadence:
		return
	ear_settings_screen_active = false
	selected_mode = mode
...
func visibility(mode_interval: int, mode_chord: int, mode_progression: int, mode_scale_mode: int, mode_cadence: int, mode_sight: int, mode_note_chase: int, mode_read: int) -> Dictionary:
	var is_ear := selected_mode == mode_interval or selected_mode == mode_chord or selected_mode == mode_progression or selected_mode == mode_scale_mode or selected_mode == mode_cadence
